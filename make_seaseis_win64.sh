...
# Windows 64bit version, compiled on Linux system
#
# NOTES
...
# For example, the Ubuntu packages for win64 cross-compilers are:
#   g++-mingw-w64-i686
...
# (2) Build Windows 64bit version using ./make_seaseis_win64.sh
# (3) Copy directory 'win64_bin' to Windows system add to binary PATH
#
# -------------------------------------------------------
#
WINVER=64
...
export F77=x86_64-linux-gnu-gfortran
export MAKE=make
